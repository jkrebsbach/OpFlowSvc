...
{
    public class WeekDayPickerView : LinearLayout
    {
        public EventHandler<WeekDayPickerViewChangedArgs> DateChanged = (sender, e) => { };
        ...
        public WeekDayPickerView(Context context) : base(context)
        {
            Initialize(Tuple.Create<IAttributeSet, int>(null, 0));
        }

        public WeekDayPickerView(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            Initialize(Tuple.Create(attrs, 0));
        }

        public WeekDayPickerView(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs)
        {
        ...
        void InflateLayout()
        {
            ...
            inflater.Inflate(Resource.Layout.WeekDayPickerLayout, this);
        ...
        void InitializeLinearLayoutProperties()
        {
            ...
            int paddingStartEnd = Convert.ToInt32(4.0);
            int paddingTopBottom = Convert.ToInt32(8.0);
        ...
        void DateButton_Click(object sender, EventArgs e)
        {
            ...
            dialog.Show(((Activity)this.Context).FragmentManager, "date_picker_dialog");
        }
        ...
        void OnDateSet(object sender, Android.App.DatePickerDialog.DateSetEventArgs e)
        {
            theDate = e.Date;
            UpdateDisplayedDate();
            DateChanged(this, new WeekDayPickerViewChangedArgs(e.Date));
        }
        ...
        {
            WeekDayPickerView hostWidget;

            public static DatePickerTextViewCalendarDialogFragment Create(WeekDayPickerView view)
            {
            ...
            public override Dialog OnCreateDialog(Bundle savedInstanceState)
            {
                ...
                var dialog = new DatePickerDialog(Context, hostWidget.OnDateSet, year, month, dayOfMonth);
                return dialog;
            }
        }
    }
