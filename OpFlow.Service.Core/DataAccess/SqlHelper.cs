...
namespace OpFlow.Service.DataAccess
{
    ...
    {
        public SqlHelper(IConfiguration configuration) : base(configuration, "CommonConnection")
        {
        }

        public SqlHelper(IConfiguration configuration, string sourceConnection) : base(configuration, sourceConnection)
        {
        }
        ...
        public async Task<List<TraySurgeryAudit>> GetDisposableAudits(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TraySurgeryAudit>> GetDisposableCounts(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ItemRationalization>> GetItemRationalization(int? specialtyId, int? surgeonId,
            decimal? minCost, decimal? maxCost, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<ItemRationalizationCase>> GetItemAuditCases(int? specialtyId, string itemName,
            ...
            DateTime beginDate, DateTime endDate, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId ?? (object)DBNull.Value),
        ...
        public async Task<int> InsertDisposableAudit(List<int> surgeryId, string target, int locationId)
        {
        ...
        public async Task<int> UpdateDisposableAudit(List<ItemAuditUpdate> audits, string target, int locationId)
        {
        ...
        public async Task<int> DeleteDisposableAudit(int surgeryId, string target, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> UpdateItemCountNeeded(int itemId, bool countNeeded, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<TrayRationalizationCompareResult> GetTrayRationalizationCompare(
            int customerId, int baselineId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<TrayConsolidationResult>> GetAnalyticsTrayConsolidationData(List<int> specialtyId, List<int> trayId, int? reallocationId,
            int? maxSize, int? minCards, int? minConsolidationInstances, int? minTargetInstances, int? minOverlap, int? maxEffect, List<int> procedureGroup, string group, int locationId)
        {
        ...
        public async Task<DataSet> GetAnalyticsTrayScopeData(List<int> specialtyId, List<int> trayId, string group, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var trayXml = GetIdentitySummary(trayId);
        ...
        public async Task<DataSet> GetSupplyConcordanceReportData(List<int> specialtyId, List<int> surgeonId,
            List<int> procedureId, List<int> cardCategoryId, List<int> cardId, string instruments, string label, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var surgeonXml = GetIdentitySummary(surgeonId);
            var procedureXml = GetIdentitySummary(procedureId);
        ...
        public async Task<int> InsertProcedureProfileMetric(string metricType, string questionType, string question, int? parentMetricAnswerId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<DataSet> GetSupplyWasteReportData(List<int> specialtyId, List<int> surgeonId,
            List<int> cardId, List<int>itemId, List<int> cardCategoryId, int? minCost, decimal? minOpen, decimal? minHold, 
            DateTime? startDate, DateTime? endDate, 
            bool fieldAll, bool fieldWaste, bool fieldOver, bool fieldUnder, string groupBy, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var surgeonXml = GetIdentitySummary(surgeonId);
            var cardXml = GetIdentitySummary(cardId);
        ...
        public async Task<DataSet> GetProcedureProfileReport(int procedureProfileId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<DataSet> GetProcedureProfileTrayAlignment(int procedureProfileId, List<int> cardId, List<int> trayId, int locationId)
        {
            var cardXml = GetIdentitySummary(cardId);
            var trayXml = GetIdentitySummary(trayId);
        ...
        public async Task<DataSet> GetProcedureProfileSupplyAlignment(int procedureProfileId, List<int> cardId, List<int> trayId, int locationId)
        {
            var cardXml = GetIdentitySummary(cardId);
            var trayXml = GetIdentitySummary(trayId);
        ...
        public async Task<DataSet> GetSupplySavingsEstimatorReportData(List<int> specialtyId, List<int> surgeonId, List<int> cardCategoryId,
            List<int> itemId, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var surgeonXml = GetIdentitySummary(surgeonId);
            var cardCategoryXml = GetIdentitySummary(cardCategoryId);
        ...
        public async Task<DataSet> GetAnalyticsCountSummaryData(List<int> specialtyId, List<int> surgeonId, List<int> cardId, List<int> cardCategoryId,
            List<int> roomGroupId, List<int> trayId, string cardType, string group, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var surgeonXml = GetIdentitySummary(surgeonId);
            var cardXml = GetIdentitySummary(cardId);
            ...
            var parameters = new[]
            {
                ...
                new SqlParameter("room_group_id", roomGroupXml ?? (object)DBNull.Value),
                new SqlParameter("tray_id", trayXml ?? (object)DBNull.Value),
                new SqlParameter("card_type", cardType ?? (object)DBNull.Value),
                new SqlParameter("group", group ?? (object)DBNull.Value),
                new SqlParameter("location_id", locationId)
            };
        ...
        public async Task<DataSet> GetAnalyticsCountSampleDispersion(string countType, List<int> specialtyId, List<int> surgeonId, List<int> trayId, List<int> itemId,
            List<int> cardCategoryId, DateTime? startDate, DateTime? endDate, string group, int locationId)
        {
            var specialtyXml = GetIdentitySummary(specialtyId);
            var surgeonXml = GetIdentitySummary(surgeonId);
            var trayXml = GetIdentitySummary(trayId);
        ...
        public async Task<int> InsertProposedTray(int? proposedTrayId, int? specialtyId, bool customized,
            string trayName, List<ProposedTrayInstrumentPost> instruments, int locationId)
        {
        ...
        public async Task<int> UpdateProposedTrayInstruments(int proposedTrayId, List<UpdateTrayInstrumentPost> instruments, int locationId)
        {
        ...
        public async Task<int> UpdateProposedTrayQuantities(int proposedTrayId, List<UpdateTrayInstrumentPost> instruments, int locationId)
        {
            var instrumentXml = GetInstrumentUpdateSummary(instruments);
        ...
        public async Task<int> DeleteProposedTrayInstrument(int proposedTrayId, int instrumentId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", proposedTrayId),
        ...
        public async Task<int> InsertProposedTrayInstrumentLog(int proposedTrayId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", proposedTrayId),
        ...
        public async Task<int> InsertTrayGroup(string trayGroup, int locationId)
        {
        ...
        public async Task<int> UpdateTrayGroup(int? trayGroupId, string groupName, List<TrayGroupTray> trays, int locationId)
        {
            var result = trayGroupId ?? -1;

            if (!trayGroupId.HasValue)
            {
                result = await InsertTrayGroup(groupName, locationId);
            }
        ...
        public async Task<int> UpdateInstrument(int instrumentId, string description, int? typeId, int? categoryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("instrument_id", instrumentId),
            ...
            var result = await ExecuteNonQueryAsync("UpdateInstrument", parameters);
        ...
        public async Task<int> UpdateProposedTray(int proposedTrayId,
            ...
            List<int> cardCategories, List<int> trayGroups, int locationId)
        {
        ...
        public async Task<int> UpdateProposedTrayDashboard(int proposedTrayId, int instances, string deploymentStatus,
            DateTime? countComplete, DateTime? auditComplete, DateTime? trayChanges, string comments, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", proposedTrayId),
        ...
        public async Task<List<TrayRationalizationStatusLog>> GetProposedTrayStatusLog(int proposedTrayId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", proposedTrayId),
        ...
        public async Task<List<TrayRationalizationItem>> GetProposedTrayInstrumentCategories(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<ProposedTrayExport> GetProposedTrayInstrumentExport(int proposedTrayId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> PutProposedTrayCards(int proposedTrayId, List<CardListTrayPost> trays, int locationId)
        {
        ...
        public async Task<List<TrayRationalizationCard>> GetProposedTrayCards(int proposedTrayId, List<CardListTrayPost> trays, int locationId)
        {
            var trayXml = GetCardTraySummary(trays);
        ...
        public async Task<List<TrayCardOverlap>> GetTrayCards(int trayId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<TrayCardOverlap>> GetProposedTrayCardOverlap(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("proposed_tray_id", trayProposalId),
        ...
        public async Task<List<TrayProposalDashboard>> GetProposedTrayDashboard(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TraySurgeryAudit>> GetProposedTrayAuditSummary(DateTime startDate, DateTime endDate, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<TrayProposalSchedule>> GetProposedTrayScheduleHistory(int? caseProfileId, int? vendorId, int? surgeonId, 
            int? trayProposalId, int? categoryId, int? questionId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("case_profile_id", caseProfileId ?? (object)DBNull.Value),
        ...
        public async Task<CaseProfile> GetCaseProfile(int caseProfileId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> UpdateScheduleRules(int userId, string surgeon, string category, DateTime? startDate, DateTime? endDate, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<int> UpdateProposedTrayRep(int trayProposalId, int userId, bool ignore, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<int> UpdateProposedTrayLog(int trayProposalLogId, 
            ...
            string comments, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> UpdateProposedTrayImageFilename(int trayProposalId, string imageFilename, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<TrayProposalSchedule>> GetSurgeryTraySchedule(int surgeryId, int? vendorId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> UpdateProposedTrayApproval(int trayProposalId, string filename, int typeId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<int> DeleteProposedTrayOrgChart(int? orgChartId, int? trayProposalId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> UpdateOrgChartAttachment(string type, int? trayProposalId, string filename, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> DeleteImplementationAttachment(int attachmentId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> UpdateImplementationAttachment(int target, string filename, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("target", target),
        ...
        public async Task<int> UpdateConsolidationPlan(List<TrayRationalization> consolidations, int locationId)
        {
        ...
        public async Task<int> UpdateSurgeryCaseProfile(int surgeryId, int? caseProfileId,
            List<CaseProfileQuestionPost> questions,  int locationId)
        {
        ...
        public async Task<int> UpdateProposedTraySchedule(int surgeryId, int? trayProposalId, int? trayGroupId,
            int caseProfileId, List<CaseProfileQuestionPost> questions, int locationId)
        {
            var questionXml = SummarizeQuestions(questions);
        ...
        public async Task<int> UpdateSurgeonPreference(int? preferenceId, string preferenceName,
            int? surgeonId, int? caseProfileId, string trayGroup, string comments, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<int> UpdateProposedTrayScheduleDetails(int scheduleId, string supplies, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<User>> GetProposedTrayCommunicationTeam(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<Messaging>> GetProposedTrayCommunication(int userId, int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<int> UpdateProposedTrayAudit(int? trayProposalId, int surgeryId, int? scrubTechUserId, int? auditUserId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId ?? (object)DBNull.Value),
        ...
        public async Task<int> UpdateProposedTrayCount(int? trayProposalId, int surgeryId, int? scrubTechUserId, int? countUserId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId ?? (object)DBNull.Value),
        ...
        public async Task<int> DeleteProposedTrayAudit(int trayProposalId, int surgeryId, string target, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<int> InsertComparableInstrument(int instrumentId, int trayItemId, int relatedInstrumentId, int relatedTrayItemId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("instrument_id", instrumentId),
        ...
        public async Task<List<Messaging>> GetMessaging(int userId, int? surgeryId, int? caseGroupId, int? recipientId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<List<MessagingGroup>> GetMessageGroups(int userId, DateTime? startDate, DateTime? endDate, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task SendMessage(int userId, int locationId,
        ...
        public async Task AcknowledgeMessage(int userId, int locationId, int messageId, bool hideMessages)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task DeletePrivateConversation(int communicationUserId, int userId,  int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<List<Card>> GetCards(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ItemMasterCategory>> GetItemCategories( int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ItemMasterType>> GetInstrumentTypes(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
            };
            var dsItems = await ExecuteCommandAsync("GetInstrumentTypes", parameters);

            return dsItems.Tables[0].DataTableToList<ItemMasterType>();
        }

        public async Task<List<ItemMasterCategory>> GetInstrumentCategories(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ItemMaster>> GetItemSutures(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ItemTray>> GetTrayItemCategories(int trayId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<ItemTrayOverlap>> GetTrayItemOverlaps(int trayId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<ItemTrayOverlap>> GetProposedTrayItemOverlaps(int trayProposalId, int? trayProposalLogId, int locationId)
        {
            DataSet dsItems;
            ...
            int locationId)
        {
            ...
            foreach (var category in categories)
            {
                category.Instruments = instruments.Where(x => x.InstrumentTypeID == category.InstrumentTypeID &&
                    ...
                    {
                        InstrumentID = i.Key,
                        InstrumentName = i.First().InstrumentName,
        ...
        public async Task<List<SurgeryCardItem>> GetSurgeryCardItems(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<CardItemCountQueryResult> GetSurgeryCardItemCounts(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<SurgerySutureCount>> GetSurgerySutureCounts(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<SurgeryTrayOpen>> GetSurgeryTrayOpens(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> UpdateSurgeryTrayFeedback(int surgeryId, int trayId, string feedback, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> UpdateSurgeryEstCompTime(int surgeryId, DateTime estCompTime, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<Card>> GetCardSurgeryDelays(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<CardWithCategory>> GetCardCategoryXRef(int? userId, int? specialtyId, string cardName, string hierarchyLevel, int? cardCategoryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId ?? (object)DBNull.Value),
        ...
        public async Task<List<CardCategoryDetail>> GetCardCategoryDetails(
            List<int> cardCategoryId, List<int> specialtyId, List<int> cardId, List<int> procedureProfileId, List<int> surgeonId,
            int locationId)
        {
            var cardCategoryXml = GetIdentitySummary(cardCategoryId);
            var specialtyXml = GetIdentitySummary(specialtyId);
        ...
        public async Task<int> InsertProcedureProfileStep(int procedureProfileId, int stepId, int duration, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> DeleteProcedureProfileStep(int procedureProfileId, int stepId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> DeleteProcedureProfileCardCategory(int procedureProfileId, int cardCategoryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
            ...
            var result = await ExecuteNonQueryAsync("DeleteProcedureProfileCardCategory", parameters);

            return result;
        }

        public async Task<int> InsertProcedureProfileCardCategory(int procedureProfileId, int cardCategoryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
            ...
            var result = await ExecuteNonQueryAsync("InsertProcedureProfileCardCategory", parameters);

            return result;
        }

        public async Task<int> UpdateProcedureProfileSteps(int procedureProfileId, List<ProcedureProfileStep> steps, int locationId)
        {
        ...
        public async Task<int> InsertProcedureProfileCpt(int procedureProfileId, string cptCode, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> UpdateProcedureProfileItem(int procedureProfileId, int? itemId, int? instrumentId, string category, int quantity, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> UpdateProcedureProfileCard(int procedureProfileId, int cardId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> UpdateProcedureProfileTrayInstrument(int procedureProfileId, int instrumentId, int trayItemId, 
            int? categoryId, int quantity, string reason, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> DeleteProcedureProfileCpt(int procedureProfileId, string cptCode, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> DeleteProcedureProfileItem(int procedureProfileId, int? itemId, int? instrumentId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> DeleteProcedureProfileTrayInstrument(int procedureProfileId, int itemId, int trayItemId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> UpdateProcedureProfile(int? procedureProfileId, string profileName, List<int> locationFilter, 
            List<int> cardCategoryId, List<int> specialtyId, int locationId)
        {
        ...
        public async Task<int> DeleteProcedureProfile(int procedureProfileId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId), 
        ...
        public async Task<int> UpdateProcedureProfileCategory(int procedureProfileId, string profileName, int? categoryId, int? ownerId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("procedure_profile_id", procedureProfileId),
        ...
        public async Task<int> UpdateProcedureProfileDashboard(int procedureProfileId, List<int> locationFilter, List<int> cards, List<int> trays, List<int> proposed, int locationId)
        {
            var locationXml = GetIdentitySummary(locationFilter);
            var cardXml = GetIdentitySummary(cards);
            var trayXml = GetIdentitySummary(trays);
        ...
        public async Task<int> UpdateCardCategories(string hierarchyLevel, int cardCategoryId, List<int> cards, int locationId)
        {
        ...
        public async Task<int> UpdateCardCategoryXRef(int cardId, List<CardCategoryXRef> categories, int locationId)
        {
        ...
        public async Task<int> UpdateCardFeedback(int feedbackId, bool response, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<SurgeryCard>> GetSurgeryCardList(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<SurgeryFlow>> GetSurgeryFlowList(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<UserLocation>> GetUserLocations(int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<int> UpdateUserLocations(int userId, List<int> locationId)
        {
            var locationXml = GetIdentitySummary(locationId);
        ...
        public async Task<OpFlowLocation> UpdateUserVendorLocation(int userId, int vendorLocationId, int providerId, int locationId)
        {
            ...
            {
                new SqlParameter("user_id", userId),
                new SqlParameter("vendor_location_id", vendorLocationId),
                new SqlParameter("provider_id", providerId),
                new SqlParameter("location_id", locationId)
            };
        ...
        public async Task<int> UpdateSurgeonProfile(int procedureProfileId, int surgeonId, int locationId)
        {
            ...
            var result = await ExecuteNonQueryAsync("UpdateSurgeonProfile", dsParameters);
        ...
        public async Task<int> CreateUser(Guid userAuthId, int? roleId, int? specialtyId, string firstName, string lastName,
            string email, string cellPhone, string initials, string title, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("user_auth_id", userAuthId),
        ...
        public async Task<int> AddSurgerySmartPhrase(int surgeryId, int smartPhraseId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddFlowSmartPhrase(int flowId, int smartPhraseId, int? stepId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> NewSmartPhrase(string phrase, int categoryId, int stepId, int roleId, 
            int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> EditSmartPhrase(int smartPhraseId, string phrase, 
            int categoryId, int userId, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteSmartPhrase(int smartPhraseId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateFlowImage(int flowImageId, string comments, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteFlowImage(int flowImageId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> NewSurgeryImage(int surgeryId, int stepId, int roleId, string comment, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> UpdateSurgeryImage(int surgeryImageId, string comments, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteSurgeryImage(int surgeryImageId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddFlowFeedback(int flowId, string feedback, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteFlowFeedback(int flowFeedbackId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateFlowPhrase(int flowId, int smartPhraseId, string comments, 
            int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteFlowPhrase(int flowId, int smartPhraseId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateSurgeryPhrase(int surgeryId, int surgeryPhraseId, string comments, 
            int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
        ...
        public async Task<int> DeleteSurgeryPhrase(int surgeryId, int smartPhraseId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> NewSurgeonNote(string phrase, int flowId, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateSurgeonNote(int surgeonNoteId, string comments, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteSurgeonNote(int surgeonNoteId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> SurgeryPhraseDebrief(int surgeryPhraseId, int stepId, int roleId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> SurgeryUpdateCaseNotes(int surgeryId, string caseNotes, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AssignCardToCase(int cardId, int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AssignRoomSetupToCase(int roomSetupId, int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AssignFlowToCard(int flowId, int cardId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AssignRoomSetupToCard(int roomSetupId, int cardId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AssignUserToCard(int cardId, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> RemoveUserFromCard(int cardId, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateCardProcedure(int cardId, int procedureId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteCardProcedure(int cardId, int procedureId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> InsertCard(string description, int ownerUserId, int? specialtyId, int? procedureId, int? templateFlowId, int? templateRoomId, int? bundleId, string bundleFlag,
            int? cardCategoryId, bool? defaultFlag, bool? specialtyDefaultFlag, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int?> ParseCardCategory(string cardCategory, int locationId)
        {
        ...
        public async Task<int> InsertCardItemFromStage(int cardId, int locationId, string procedure, string surgeon)
        {
            var dsParameters = new[]
            {
                new SqlParameter("card_id", cardId),
        ...
        public async Task<int> InitializeCard(int cardId, int locationId)
        {
        ...
        public async Task<int> DeleteCard(int cardId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateCardQuantity(int cardId, CardQuantityEdit quantity, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateCardQuantityRequest(int cardId, CardQuantityEdit quantity, int locationId, int userId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateSurgeryItemQuantity(int surgeryId, CardQuantityEdit quantity, int locationId,  int userId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddSurgeryTemporaryTray(int surgeryId, string trayName, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
            ...
            return await ExecuteNonQueryAsync("InsertSurgeryTemporaryTray", dsParameters);
        }
        public async Task<int> AddSurgeryProposedTray(int surgeryId, int trayProposalId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddSurgeryProposedTrayGroup(int surgeryId, int trayGroupId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddSurgeryUser(int surgeryId, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteSurgeryUser(int surgeryId, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddSurgeryProcedure(int surgeryId, int procedureId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateSurgeryProcedure(int surgeryId, string cptCode, string performedFlag, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> DeleteSurgeryProcedure(int surgeryId, string cptCode, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateStaffChange(int surgeryId, string staffChange, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddCustomSurgeryTrayItem(int surgeryId, int trayId, int itemId, int quantity, int locationId, int userId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> AddSurgeryMudBox(int surgeryId, string trayName, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
            ...
            var dsResult = await ExecuteCommandAsync("InsertSurgeryMudBox", dsParameters);

            var identity = dsResult.Tables[0].DataTableToList<InsertionResult>();

            return identity.First().Identifier;
        }        

        public async Task<int> UpdateSurgeryCount(int surgeryId, List<SurgeryCountItemPost> itemUsage, string countComments, string surgeryType, int locationId, int userId)
        {
        ...
        public async Task<int> UpdateSurgeryInstrumentCount(int surgeryId, List<SurgeryCountItemPost> instrumentUsage, int locationId, int userId)
        {
        ...
        public async Task<int> UpdateSurgeryProposedCount(int surgeryId, List<SurgeryCountItemPost> proposedUsage, int locationId, int userId)
        {
        ...
        public async Task<int> UpdateSurgerySutureCount(int surgeryId, List<SurgeryCountSuturePost> sutureUsage, List<int> deletedSutures, int locationId, int userId)
        {
        ...
        public async Task<int> UpdateSurgeryMetricAnswers(int surgeryId, List<SurgeryMetricPost> metricAnswers, int locationId, int userId)
        {
        ...
        public async Task<List<SurgeryCPTCode>> GetSurgeryCPTCodes(int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> SurgeryReviewComplete(int surgeryId, DateTime reviewComplete, int userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> SurgeryEditProperties(int surgeryId, int roomId, DateTime surgeryScheduleDate, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<SmartPhrase>> GetSmartPhrases(int? categoryId, int? specialtyId, int? userId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<SmartPhraseCategory>> GetSmartPhraseCategories(int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<FlowPhrase>> GetFlowPhrases(int flowId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<SurgeryPhrase>> GetSurgeryPhrases(int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<FlowImage>> GetFlowImages(int flowId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<FlowImage> GetFlowImage(int flowImageId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("flow_image_id", flowImageId),
        ...
        public async Task<List<SurgeryImage>> GetSurgeryImages(int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<RoomSummary>> GetSurgeryRoomSummary(int surgeryId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<RoomSummary>> GetSurgeryRoomOverview(
            ...
            DateTime surgeryDate, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId ?? (object)DBNull.Value),
        ...
        public async Task<List<SurgeryDelay>> GetFlowSurgeryDelays(int flowId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowSurgeonNote>> GetSurgeonNotes(int flowId, int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<PatientSurgery> GetSurgery(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<SurgeryMetric>> GetSurgeryMetrics(int surgeryId, int locationId)
        {
            ...
            foreach (var metric in metrics)
            {
                ...
                foreach (var answer in metric.SurgeryAnswers)
                {
                    try
                    {
                        selectedAnswers = JsonSerializer.Deserialize<List<int>>($"[{metric.SurgeryAnswer}]");
                    }
                    catch { }
        ...
        public async Task<List<SurgerySearchResult>> LoadProposalCounts(List<SurgerySearchResult> schedule, int locationId)
        {
        ...
        public async Task<int> UpdateProposedTrayComments(int trayProposalId, string comments, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<SurgerySearchResult>> GetSurgeonCases(int userId, DateTime begDate, DateTime endDate, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<List<Surgery>> GetSurgeryAlerts(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task <List<SurgeryDelayReason>> GetSurgeryDelayReasons(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<SurgeryUser>> GetSurgeryUsers(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<SurgeryVendorRep>> GetSurgeryVendorReps(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<CardFlowRoom> GetBundleDefaultCardFlowRoom(int bundleId, int userId, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<Surgeon>> GetImportSurgeons(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<Procedure>> GetImportProcedures(string importSurgeon, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<CardFlowRoom>> GetProcedureDefaultCardFlowRoom(string cptCode, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<CardFlowRoom>> GetSpecialtyProcedureDefaultCardFlowRoom(int locationId, string cptCode)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<CardFlowRoom>> GetMultipleProceduresDefaultCardFlowRoom(int locationId, int specialtyId, string cptCodes)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<CardFlowRoom>> GetSpecialtyMultipleProceduresDefaultCardFlowRoom(int locationId, int specialtyId, string cptCodes)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<CardBundle>> GetBundles(int? specialtyId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId ?? (object)DBNull.Value),
        ...
        public async Task<List<BundleProcedure>> GetBundleProcedures(int bundleId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("bundle_id", bundleId),
        ...
        public async Task<int> NewBundle(string description, int specialtyId, List<int> procedures, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
            ...
            await UpdateBundleProcedures(bundleId, procedures, locationId);

            return bundleId;
        }

        public async Task<int> UpdateBundle(int bundleId, string description, int specialtyId, List<int> procedures, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("bundle_id", bundleId),
        ...
        private async Task<int> UpdateBundleProcedures(int bundleId, List<int> procedures, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("bundle_id", bundleId),
        ...
        public async Task<List<BundleProcedure>> GetSurgeryProcedures(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<Procedure>> GetProcedures(int? specialtyId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId ?? (object)DBNull.Value),
        ...
        public async Task<List<InternalSpecialty>> GetSpecialtiesInternal()
        {
            ...
            var result = dsSchedules.Tables[0].DataTableToList<InternalSpecialty>();
        ...
        public async Task<int> InsertSpecialtyProcedureGroup(int specialtyId, int procedureGroupId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId),
        ...
        public async Task<int> DeleteSpecialtyProcedureGroup(int specialtyId, int procedureGroupId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId),
        ...
        public async Task<List<Surgeon>> GetSurgeons(int? specialtyId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("specialty_id", specialtyId ?? (object)DBNull.Value),
        ...
        public async Task<Flow> GetFlow(int flowId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<Flow>> GetCardFlowList(int cardId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("card_id", cardId),
        ...
        public async Task<List<FlowStepTiming>> GetFlowTimings(int flowId, int locationId)
        {
            var parameters = new[]
                {
                    new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowStepSurgeryTiming>> GetFlowSurgeryTimings(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<List<FlowStepInstructionResult>> GetFlowInstructions(int flowId, int? surgeryId, int locationId)
        {
            var parameters = new[]
                {
                    new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowStep>> GetFlowComments(int flowId, int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowMessaging>> GetFlowMessaging(int flowId, int stepId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowContent>> GetFlowContent(int flowId, int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<FlowNotification>> GetFlowNotifications(int flowId, int? stepId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<List<Step>> GetSteps(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<FlowFeedback>> GetFlowFeedback(int flowId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<int> DeleteFlowStep(int flowId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<int> UpdateSurgeryStep(int stepId, string stepDescription, string notificationType, bool stepTiming, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("step_id", stepId),
        ...
        public async Task<int> AddSurgeryStep(string stepDescription, string notificationType, bool stepTiming, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("step_description", stepDescription),
        ...
        public async Task<int> DeleteSurgery(int surgeryId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("surgery_id", surgeryId),
        ...
        public async Task<int> DeleteSurgeryStep(int stepId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("step_id", stepId),
        ...
        public async Task<int> InsertFlowNotification(int flowId, int stepId, int notificationType, string message, 
            string smsNumber, string emailAddress, int? messagingUserId, int? messagingRoleId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<int> DeleteFlowNotification(int flowNotificationId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_notification_id", flowNotificationId),
        ...
        public async Task<int> NewFlow(int cardId, int roomSetupId, string description, int userId, 
            bool defaultFlow, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<int> UpdateFlow(int flowId, int cardId, int roomSetupId, string description, 
            int userId, bool defaultFlow, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<int> DeleteFlow(int flowId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("flow_id", flowId),
        ...
        public async Task<ImportResult> InsertStagingData(int locationId, int? secureId, IImportData sourceData, FileParserRelations relations, int authenticatedUserID)
        {
            ...
            else if(sourceData is ScheduleBase scheduleBase)
            {
                ...
                foreach (var secondarySurgeon in scheduleBase.SecondarySurgeons)
                {
                    ...
                    {
                        await AddSurgeryUser(result.Identity, surgeon.UserID, locationId);
                    }
                }
            }
        ...
        public async Task<InstrumentLookup> GetTrayInstrumentLookups(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TrayProposalSchedule>> GetProposedTraySchedule(int? trayProposalId, int? vendorId, int userId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId ?? (object)DBNull.Value),
        ...
        public async Task<List<TrayRationalization>> GetBaselineTrays(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TrayQuestionSummary>> GetTrayQuestions(int? itemId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<TrayProposalPhase>> GetTrayProposalPhases(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TrayGroup>> GetTrayGroups(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<TrayRationalizationCardCategory>> GetProposedTrayCardCategories(int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<CaseProfile>> GetCaseProfiles(int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<SurgeonPreference>> GetSurgeonPreferences(int locationId)
        {
            ...
            {
                surgeonPreference.TrayGroupID = JsonSerializer.Deserialize<List<int>>(surgeonPreference.TrayGroup);
            }
        ...
        public async Task<TrayProposalScheduleRule> GetProposedTrayScheduleRules(int userId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("user_id", userId),
        ...
        public async Task<List<RoomGroup>> GetRoomGroups(int locationId)
        {
            var dsParameters = new[]
            {
                new SqlParameter("location_id", locationId),
        ...
        public async Task<List<ProposedTrayOrgChart>> GetOrgChartAttachments(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<ImplementationAttachment>> GetImplementationAttachments(int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("location_id", locationId)
        ...
        public async Task<List<TrayRationalizationItem>> GetProposedTrayInstruments(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("proposed_tray_id", trayProposalId),
        ...
        public async Task<List<TrayApproval>> GetProposedTrayApprovalDocuments(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<TraySurgeryAudit>> GetProposedTrayAudits(int? trayProposalId, DateTime? startDate, DateTime? endDate, int locationId)
        {
            var parameters = new[]
            {
        ...
        public async Task<List<TraySurgeryAudit>> GetProposedTrayCounts(int? trayProposalId, DateTime? startDate, DateTime? endDate, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("proposed_tray_id", trayProposalId ?? (object)DBNull.Value),
        ...
        public async Task<List<TrayCountSummary>> GetTrayCountSummary(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("proposed_tray_id", trayProposalId),
        ...
        public async Task<List<SourceTraySummary>> GetSourceTraySummary(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<TrayRationalizationCardCategory>> GetProposedTrayCardCategories(int trayProposalId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
        ...
        public async Task<List<TrayProposalLog>> GetProposedTrayLog(int proposedTrayId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", proposedTrayId),
        ...
        public async Task<TrayRationalizationDetailResult> GetTrayRationalizationDetail(int trayProposalId,
            string type, int? itemId, int locationId)
        {
            var parameters = new[]
            {
                new SqlParameter("tray_proposal_id", trayProposalId),
