...
namespace OpFlow.Service.DataAccess
{
    ...
    public class PDFTable
    {
        ...
        /// <summary>Contains current row objects added directly via AddHtml or AddImage methods</summary>
        ...
        /// <param name="data">Enumerable collection of strings and images</param>
        public void AddHtml(System.Collections.IEnumerable data)
        {
        ...
        /// <summary>Depth of recursion into AddHtml function</summary>
        private int HtmlDepth = 0;
        /// <summary>Maximum allowed depth of recursion into AddHtml function</summary>
