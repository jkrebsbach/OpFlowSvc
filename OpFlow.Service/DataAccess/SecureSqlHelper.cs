            ...
            int userId, string userFirstName, string userLastName, int? userRoleId)
        {
            ...
            if (sourceData is ScheduleImport schedule)
            {
                var dsParameters = new[]
                {
                    ...
                    new SqlParameter("last_name", (object)DBNull.Value),
                    new SqlParameter("first_name", (object)DBNull.Value),
                    new SqlParameter("middle_initial", (object)DBNull.Value),
                    new SqlParameter("birth_date", (object)DBNull.Value),
                    new SqlParameter("bmi", (object)DBNull.Value),
                    new SqlParameter("gender", (object)DBNull.Value),
                    new SqlParameter("medical_history", (object)DBNull.Value),
                    new SqlParameter("risk_factors", (object)DBNull.Value),
                    new SqlParameter("medications", (object)DBNull.Value),
                    new SqlParameter("allergies", (object)DBNull.Value),
